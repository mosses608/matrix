        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                ...
                <div class="row centered-ajax-component-loader" id="projects-container">
                    ...
                    <div class="load-single-notification-component">
                        <h1>{{$news->news_title}} | <span style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:14px; color:orange;">Posted on {{$news->created_at}}</span></h1>
