    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                <h6 style="text-align: center;">News Updates</h6>
                <div class="row centered-ajax-component-loader" id="projects-container">
                   
                    @foreach($notifications as $news)
                    <div style="margin: 10px;" class="load-single-notification-component">
                        <h6>{{$news->news_title}} | <span style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:14px; color:orange;">Posted on {{$news->created_at}}</span></h6>
                        @if($news->news_picture !="")
                        <img src="{{asset('storage/' . $news->news_picture)}}" alt="News Picture">
                        @endif
