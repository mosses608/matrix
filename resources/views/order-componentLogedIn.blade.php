                ...
                <div class="sidebar-contents">
                    <div id="sidebar-menu" class="sidebar-menu">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="/logedin-order-components"><img src="assets/img/employee.svg" alt="sidebar_img"><span>
                                        Order Components</span></a>
                            </li>
                            <li>
                                <a href="/logedInnews"><img src="assets/img/company.svg" alt="sidebar_img"> <span>
                                        News</span></a>
                            </li>
                            <li>
                        ...
                        <ul class="logout">
                            <li>
                                <a href=""><img src="assets/img/logout.svg" alt="sidebar_img"><span>Log
                                        out</span></a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="page-wrapper">
                ...
                <div class="row centered-ajax-component-loader" id="projects-container">
                    ...
                    <form action="/comporders" method="POST" class="process-order-prolong">
                        @auth('account')
                            ...
                            <input type="number" name="quantity" id="" class="quantity_component" required><br><br>
                            ...
                            <input type="text" name="price" id="" value="{{$component->component_price}}" class="price_component" required><br><br>
                            <label for="">Total Price:</label>
                            <input type="number" name="total_price" id="" class="total_price" required><br><br>
            ...
            <div class="popup-overlay" id="popup-overlay">
                <div class="popup">
                    ...
                    <!-- Order Form -->
                    <form action="/comporders" method="POST" class="order-form">
                        @csrf
                        @auth('account')
                        <!-- Name Field -->
                        ...
                        <div class="form-group">
                            ...
                            <input style="width: : 100%; height: 40px;" type="hidden" name="name" id="" value="{{Auth::guard('account')->user()->name}}">
                        @error('name')
                        ...
                        <!--<label for="">Component Name:</label>-->
                        <input type="hidden" name="component_name" id="" value="{{$component->component_name}}"><br><br>
                        <label for="">Quantity:</label><br>
                        <input type="number" name="quantity" id="quantity_component" class="quantity_component"><br><br>
                        <!--<label for="">Component Price</label>-->
                        <input type="hidden" name="price" id="price_component" value="{{$component->component_price}}" class="price_component"><br><br>
                        <label for="">Total Price:</label>
                        <input type="number" name="total_price" id="total_price" class="total_price"><br><br>
                        <!-- Phone Number Field -->
                        <div class="form-group">
...
<script>
    document.getElementById('quantity_component').addEventListener('input', function() {
        const quantity = parseInt(this.value);
        const price = parseFloat(document.getElementById('price_component').value);
