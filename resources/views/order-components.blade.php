...
.single-looped-component {
    flex: 1 1 calc(33.333% - 20px); /* Adjust percentage for responsive design */
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    ...
    <body class="antialiased">
        <header style="position: absolute;" class="home-layout-container-header">
            <a href="/"><img src="{{asset('assets/images/matrix-logo.png')}}" alt="Logo Picture"></a>
            <h1 style="display: none;">Welcome to The House of Matrix</h1>
            <div class="side-bar-top-menus">
                <button><a href="/"><i class="fa fa-home"></i> Home</a></button>
                <button><a href="/order-components"><i class="fa fa-shopping-cart"></i> Order Components</a></button>
                <button><a href="/news"><i class="fas fa-newspaper"></i> News</a></button>
                <button><a href="/about"><i class="fas fa-info-circle"></i> About Us</a><button>
                <!-- <button><a href="/services"><i class="fas fa-tools"></i> Our Services</a></button> -->
                <button><a href="/contact"><i class="fas fa-phone"></i> Contact Us</a></button>
                @auth('account')
                <form action="/logout" method="POST" class="logout-user">
                    @csrf
                    <button type="submit" class="inavlidate-account-user"><i class="fa fa-sign-out"></i> Logout</button>
                </form>
                @else
                <button><a href="/login"><i class="fa fa-sign-in"></i> Login</a></button>
                @endauth
            </div>
        </header>
        <div class="side-menu-mobile-view-holder">
            <button><a href="/">Home</a></button>
            <button><a href="/news">News</a></button>
            <button><a href="/about">About Us</a></button>
            <button><a href="#">Contact Us</a></button>
            <button><a href="/order-components">Order Components</a></button>
...
<script>
    ...
    const currentDateOptions = {weekly: 'long' , year: 'numeric'};
    const formattedDate = currentDate.toLocaleDateString('en-US',currentDateOptions);
    ...
    document.querySelector('.currentDate').textContent=formattedDate;
        ...
        <script>
            function closeFlashMessage(){
                document.querySelector('.viewable-flash-message').style.display='none';
            }
            function showSideMenusMobile(){
            document.querySelector('.side-menu-mobile-view-holder').classList.toggle('active');
            document.querySelector('.toggle-view-mobile').style.display='block';
            document.querySelector('.toggle-view-mobile').style.color='#000';
            }
        </script>
    </body>
</html>
