            ...
            <div class="content container-fluid">
                ...
                <div class="row centered-ajax-component-loader" id="projects-container">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 pb-1" style="padding-left: 3px; padding-right: 3px;">
                        <a href="{{ url('order_componentLogedIn/' . $component->id) }}">
                ...
                <div class="text-center">
                    ...
                    <button id="load-more" class="btn btn-primary" data-next-page="{{ $components->currentPage() + 1 }}" data-total-pages="{{ $components->lastPage() }}" style="margin-top: 20px;">
                        Load More
                    </button>
                    @endif
                </div>
